  ...
  return (
    <section ref={sectionRef} className="bg-black">
      ...
      <SectionGrid
        ...
        items={[
          { title: "E-Detailers",                   img: "https://d218mh3sadleh5.cloudfront.net/Website/Internal/Medtrix_2026/Image/ed1.png", desc: "Designed for Veeva and other leading platforms" },
