    ...
    <section className="relative isolate z-10 px-6 pb-[40px] lg:pb-20 bg-black mt-[50px] lg:mt-[50px] lg:px-0">
      <div className="flex flex-col-reverse  mx-auto w-[90%] md:w-[80%] md:flex-row items-center justify-between gap-0">
        ...
        <div className="text-left flex lg:w-[55%] flex-col gap-0">
          ...
          <motion.p
            className="text-[16px] text-center lg:text-left lg:text-[19px] text-[#d1d5db] leading-relaxed mt-5"
            custom={0}
            initial="hidden"
            animate="visible"
          ...
          <motion.p
            className="text-[16px] lg:text-[19px] text-center lg:text-left text-[#d1d5db] mt-3 leading-relaxed"
            custom={1}
            initial="hidden"
            animate="visible"
            variants={paraVariants}
