export const projectDetails = [
  {
    ...
    subtitle:
      "A first-of-its-kind interactive 3D anatomy platform built for medical representatives and HCPs to visualise facial structures with clinical precision.",
    tags: ["MOBILE APP", "3D", "MEDICAL AFFAIRS"],
    stack: "Unity 3D · iOS · Android",
    ...
    challenge: {
      ...
      content: [
        "Medical representatives struggled to communicate complex facial anatomy to healthcare professionals using static 2D brochures and printed materials.",
    ...
    solution: {
      ...
      content: [
        "We designed and developed a fully interactive 3D face anatomy application using Unity 3D, allowing users to rotate, zoom, and isolate individual anatomical layers in real time.",
    ...
    result: {
      heading: "The Result",
      stats: [
        { value: "2×", label: "Faster HCP Conversations" },
        { value: "50%", label: "Shorter Time-to-Market" },
        { value: "40%", label: "Increase in Rep Confidence Score" },
        { value: "1", label: "Best Innovation Nomination 2024" },
      ],
      content: [
        "The app was rolled out to over 200 medical representatives across 12 markets within the first quarter of launch.",
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    subtitle:
      "A comprehensive go-to-market strategy and commercial launch blueprint for TRYVIO, Idorsia's novel insomnia treatment entering a highly competitive market.",
    tags: ["STRATEGY", "LAUNCH PLANNING", "MARKET ACCESS"],
    stack: "Strategic Consulting · Market Research · Workshop Facilitation",
    timeline: "8 Months / Completed",

    challenge: {
      heading: "The Challenge",
      content: [
        "TRYVIO was entering a crowded insomnia market dominated by well-established brands with deep payer relationships and strong physician loyalty.",
    ...
    solution: {
      heading: "Our Solution",
      content: [
        "We conducted a deep competitive landscape analysis across 8 key markets, mapping payer archetypes, prescriber segments, and patient journey touchpoints.",
    ...
    result: {
      heading: "The Result",
      stats: [
        { value: "8", label: "Markets Analysed" },
        { value: "3×", label: "Faster Internal Alignment" },
        { value: "92%", label: "Launch Readiness Score" },
        { value: "6", label: "Weeks Ahead of Schedule" },
      ],
      content: [
        "The strategy was adopted as the global commercial blueprint for TRYVIO's launch across all priority markets.",
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    subtitle:
      "End-to-end commercial execution support for Stemline Therapeutics, enabling high-volume field operations across oncology accounts in record time.",
    tags: ["COMMERCIAL EXECUTION", "ONCOLOGY", "FIELD FORCE"],
    stack: "Field Force Management · CRM Integration · Training",
    timeline: "12 Months / Completed",

    challenge: {
      heading: "The Challenge",
      content: [
        "Stemline Therapeutics needed to rapidly scale their oncology field force to cover a large number of high-value accounts without compromising on quality of engagement.",
    ...
    solution: {
      heading: "Our Solution",
      content: [
        "We deployed a dedicated commercial execution team embedded within Stemline's operations, providing both strategic oversight and day-to-day field management.",
    ...
    result: {
      heading: "The Result",
      stats: [
        { value: "60%", label: "Reduction in CRM Admin Time" },
        { value: "35%", label: "Increase in Account Coverage" },
        { value: "4×", label: "Improvement in Forecast Accuracy" },
        { value: "120+", label: "Reps Trained & Deployed" },
      ],
      content: [
        "Account coverage increased by 35% within the first six months, with the field team consistently exceeding quarterly targets.",
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    subtitle:
      "A unified global digital platform connecting Nestlé Health Science with healthcare professionals across 20+ markets, delivering personalised content at scale.",
    tags: ["DIGITAL PLATFORM", "HCP ENGAGEMENT", "GLOBAL"],
    stack: "Next.js · Contentful CMS · Salesforce Marketing Cloud",
    ...
    solution: {
      heading: "Our Solution",
      content: [
        "We architected and built a single global HCP platform on Next.js with a headless CMS, consolidating all 14 regional portals into one unified experience.",
    ...
    result: {
      heading: "The Result",
      stats: [
        { value: "14→1", label: "Portals Consolidated" },
        { value: "3×", label: "Increase in HCP Engagement" },
        { value: "20+", label: "Markets Live at Launch" },
        { value: "65%", label: "Reduction in Content Ops Cost" },
      ],
      content: [
        "All 14 regional portals were successfully migrated and consolidated into a single platform, live across 20+ markets on day one.",
