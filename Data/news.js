export const newsData = [
  ...
  {
    id: 8,
    pageTag: "medtrix-named-mmm-agency-100-2026",
    date: "June 2026",
    category: "Conference",
    title: "MedTrix Named One of MM+M's Agency 100 for 2026",
    thumbnail: "https://d218mh3sadleh5.cloudfront.net/Website/Internal/Medtrix_2026/Image/news0.png",
    thumbnailMbl: "",
    body: [
      "Healthcare communications has changed dramatically over the last decade. Audiences have evolved, expectations have shifted, and the need for meaningful, connected experiences has never been greater.",
      "As the industry continues to transform, so do the organizations helping shape its future.",
      "We're thrilled to be recognized as one of MM+M's Agency 100 for 2026.",
      "For MedTrix, this recognition represents a journey that has unfolded over the last 14 years. Throughout that time, we've had the privilege of growing alongside our clients and evolving with the changing needs of healthcare organizations and technology.",
      "From scientific communications and medical affairs to creative, digital, and commercial solutions, our capabilities have expanded, but our purpose has remained the same: helping clients navigate complexity and create meaningful impact through communications grounded in science and driven by insight.",
      "As we continue to evolve with AI and technology across everything we do, we're excited about the opportunities ahead to create even greater impact for our clients.",
      "If you're attending as well, we would love to connect and continue the conversation.",
    ],
    link: "https://www.mmm-online.com/2026-agency-100/",
    linkLabel: "to explore the complete MM+M Agency 100 report.",
    images: [
      { desktop: "https://d218mh3sadleh5.cloudfront.net/Website/Internal/Medtrix_2026/Image/nu_0.png", mobile: "https://d218mh3sadleh5.cloudfront.net/Website/Internal/Medtrix_2026/Image/nu_0.png" },
    ],
  },
];
