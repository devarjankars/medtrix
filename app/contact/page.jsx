    ...
    <section className="w-[90%] md:w-[80%] mx-auto py-16 md:py-24">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.6fr] gap-10 lg:gap-14 items-start">
          ...
          {submitted ? (
            ...
            <form onSubmit={(e) => { e.preventDefault(); setSubmitted(true); }} className="flex flex-col gap-5">
              ...
              <div className="form-field flex flex-col gap-1.5 opacity-0">
                ...
                <textarea required rows={6} placeholder="Tell us about your project..."
              ...
              <div className="form-field opacity-0">
                <motion.button type="submit"
                  ...
                  style={{ background: "linear-gradient(135deg, #E1251B 0%, #ff4d42 100%)", boxShadow: "0 0 20px rgba(225,37,27,0.4)" }}
                >
        ...
        <div className="flex flex-col gap-6 order-first lg:order-last lg:sticky lg:top-24" ref={cardsRef}>
          ...
          {/* Map */}
          <div ref={mapRef} className="relative rounded-2xl overflow-hidden border border-white/10 opacity-0 lg:min-h-[480px]">
            <img src="/map.png" alt="Medtrix office locations"
              className="w-full h-full object-cover hidden md:block lg:min-h-[480px]" />
            <img src="/mobile_map.png" alt="Medtrix office locations"
