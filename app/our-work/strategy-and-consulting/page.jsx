...
const CATEGORY = "STRATEGY AND CONSULTING";
...
function PageInner() {
  ...
  function openProject(project) {
    router.push(`/our-work/strategy-and-consulting?project=${project.id}&from=${encodeURIComponent("/our-work/strategy-and-consulting")}`, { scroll: false });
  }

  function goBack() {
    router.push("/our-work/strategy-and-consulting", { scroll: false });
  }
...
export default function StrategyConsultingWorkPage() {
  return (
    <Suspense>
      <PageInner />
    </Suspense>
