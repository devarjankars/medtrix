...
const CATEGORY = "MEDICAL AFFAIRS";
...
function PageInner() {
  ...
  function openProject(project) {
    router.push(`/our-work/medical-affairs?project=${project.id}&from=${encodeURIComponent("/our-work/medical-affairs")}`, { scroll: false });
  }

  function goBack() {
    router.push("/our-work/medical-affairs", { scroll: false });
  }
...
export default function MedicalAffairsWorkPage() {
  return (
    <Suspense>
      <PageInner />
    </Suspense>
